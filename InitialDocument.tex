...
This project is about machine learning. In simple words machine learning can be described as a technique or method that involves making the machine to learn and behave based on training data given and past experience to improve its performance. To cite from \cite{Alpaydin2010MachineLearning} (page XXX section):
\begin{quote}
...
XXX describe the setting (simple one is enough) XXX
XXX roughly one page; overview on methods of machine learning XXX
