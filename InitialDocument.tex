...
To refer from \cite{Doxygen}(page 1): Doxygen Documentation : Doxygen is a documentation system for my types of programming language. Example C, C++. C#, Java, Python, PHP.
