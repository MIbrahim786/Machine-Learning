...
\end{itemize}
The total number of combinations the table could have is $3 \cdot 3 \cdot 2 \cdot 2 = 36$ possible inputs for the function. We having only $14$ possible values in the table, while 22 values are missing. To find out the missing values we compute decision tree. Once we know the decision tree it is easy to complete the table.
